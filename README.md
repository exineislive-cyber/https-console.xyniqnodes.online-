...
<html>
    <head>
        <title>XYNIQ HOSTING</title>

        
                    <meta charset="utf-8">
            <meta http-equiv="X-UA-Compatible" content="IE=edge">
            <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
            <meta name="csrf-token" content="E9j0iknTqcDwbR97P7HJNHqCAHxX2l8tlgVLTKf9">
            ...
            <meta name="theme-color" content="#0e4688">
                                    ...
                                    <script>
                    window.PterodactylUser = {"uuid":"658e1c1c-d857-4641-a117-72c461c29a27","username":"test","email":"test@ok","name_first":"test","name_last":"test","language":"en","root_admin":false,"use_totp":false,"gravatar":true,"created_at":"2025-12-16T12:38:36.000000Z","updated_at":"2025-12-16T12:46:26.000000Z"};
                </script>
                                        <script>
                    window.SiteConfiguration = {"name":"XYNIQ HOSTING","locale":"en","recaptcha":{"enabled":true,"siteKey":"6LcJcjwUAAAAAO_Xqjrtj9wWufUpYRnK6BW8lnfn"},"blueprint":{"disable_attribution":false}};
                </script>
                            <style>
        ...
        <!-- ❄️ Premium Winter Effects – Stable Snow + Tree + Lights -->
...
.light {
  ...
  border-radius: 50%;
  background: #fff2b2;
  box-shadow: 0 0 6px rgba(255,242,178,0.9);
...
.winter-tree {
  ...
  width: 26px;
  height: 40px;
  background: linear-gradient(#1f8f4a, #126b35);
  clip-path: polygon(50% 0%, 0% 100%, 100% 100%);
  z-index: 2147483646;
  filter: drop-shadow(0 0 4px rgba(31,143,74,.5));
}
...
<script>
(function () {
  const SNOW_EMOJIS = ["❄", "❅"]; // white only
  const MAX = 26;

  function spawnSnow() {
    if (document.querySelectorAll(".snowflake").length >= MAX) return;

    const s = document.createElement("div");
    s.className = "snowflake";
    s.textContent = SNOW_EMOJIS[Math.floor(Math.random()*SNOW_EMOJIS.length)];
    ...
    s.style.animation = `snowFall ${duration}s linear`;
...
<html>
  ...
  <script src="/extensions/nebula/libraries/fetchStyle.js?1765694561"></script>
  <script src="/extensions/nebula/libraries/currentPage.js?1765694561"></script>
  <script src="/extensions/nebula/libraries/fetchServerId.js?1765694561"></script>
  <script src="/extensions/nebula/libraries/statusOrb.js?1765694561"></script>
  <script src="/extensions/nebula/libraries/customContextMenu.js?1765694561"></script>
  <script src="/extensions/nebula/libraries/copyapi.js?1765694561"></script>
  <script src="/extensions/nebula/libraries/assignElementIds.js?1765694561"></script>
  <script src="/extensions/nebula/libraries/fileMode.js?1765694561"></script>
  <script src="/extensions/nebula/libraries/insertAboveApp.js?1765694561"></script>
  <script src="/extensions/nebula/libraries/sidebarMiddleClick.js?1765694561"></script>
  <script src="/extensions/nebula/libraries/viewportVisibility.js?1765694561"></script>
  <script src="/extensions/nebula/libraries/floatingWindows.js?1765694561"></script>
  <script src="/extensions/nebula/libraries/keybinds.js?1765694561"></script>  <script src="/extensions/nebula/libraries/keybindsModal.js?1765694561"></script>    <script src="/extensions/nebula/libraries/assets/popper.min.js"></script>
  <script src="/extensions/nebula/libraries/assets/tippy-bundle.umd.min.js"></script>
<script src="/extensions/nebula/libraries/errorHandler.js?1765694561"></script>
<script src="/extensions/nebula/libraries/locationchange.js?1765694561"></script>
<script src="https://cdn.nebula.style/modules/dart.js?6636"></script>

<!-- Import stylesheets. -->
<style>
  @import url("/extensions/nebula/libraries/statusOrb.css?1765694561");
  @import url("/extensions/nebula/libraries/fixUserInterfaceBugs.css?1765694561");
  @import url("/extensions/nebula/libraries/customContextMenu.css?1765694561");
  @import url("/extensions/nebula/libraries/fileMode.css?1765694561");
  @import url("/extensions/nebula/libraries/borderRadius.css?1765694561");
  @import url("/extensions/nebula/libraries/extendedStyles.css?1765694561");
  @import url("/extensions/nebula/libraries/tagStyling.css?1765694561");
  @import url("/extensions/nebula/libraries/floatingWindows.css?1765694561");
  @import url("/extensions/nebula/libraries/patterns.css?1765694561");
  @import url("/extensions/nebula/libraries/animations.css?1765694561");

      @import url("/extensions/nebula/libraries/serversCards.css?1765694561");
  
      @import url("/extensions/nebula/libraries/keybindsModal.css?1765694561");
    ...
    @import url("https://cdn.nebula.style/icons/bootstrap/bootstrap-icons.css");
                      @import url("https://cdn.nebula.style/icons/lucide/lucide.css");                         </style>  
  ...
  <div class="sidebarContent">
    ...
    <div class="tooltip-toggle">
      ...
      <button data-tippy-content="Home" oncontextmenu="showContextMenu(event, `/`)" onclick="sidebarRefresh();sidebarButtonEvent('home')" id="sidebarMainHome" class="sidebarButton">
                <i class="sidebarIcon icon-layers"></i>
    ...
    <div id="sidebarCategoryServer" class="sidebarCategory">
      ...
      <div class="tooltip-toggle">
        ...
        <button data-tippy-content="Terminal" oncontextmenu="showContextMenu(event, `/server/${fetchServerId()}`)" onclick="sidebarRefresh();sidebarButtonEvent('serverTerminal')" id="sidebarServerTerminal" class="sidebarButton">
                    <i class="sidebarIcon icon-terminal-square"></i>
                    <span class="wideSidebarSpan" style="color: var(--sidebarPrimary)">Terminal</span>        </button>
      </div>
      ...
      <div class="tooltip-toggle">
        ...
        <button data-tippy-content="Files" oncontextmenu="showContextMenu(event, `/server/${fetchServerId()}/files`)" onclick="sidebarRefresh();sidebarButtonEvent('serverFiles')" id="sidebarServerFilemanager" class="sidebarButton">
                    <i class="sidebarIcon icon-folder-open"></i>
      ...
      <div class="tooltip-toggle">
        ...
        <button data-tippy-content="Databases" oncontextmenu="showContextMenu(event, `/server/${fetchServerId()}/databases`)" onclick="sidebarRefresh();sidebarButtonEvent('serverDatabases')" id="sidebarServerDatabases" class="sidebarButton">
                    <i class="sidebarIcon icon-database"></i>
                    <span class="wideSidebarSpan" style="color: var(--sidebarPrimary)">Databases</span>        </button>
      </div>
      ...
      <div class="tooltip-toggle">
        ...
        <button data-tippy-content="Schedules" oncontextmenu="showContextMenu(event, `/server/${fetchServerId()}/schedules`)" onclick="sidebarRefresh();sidebarButtonEvent('serverSchedules')" id="sidebarServerSchedules" class="sidebarButton">
                    <i class="sidebarIcon icon-calendar-clock"></i>
                    <span class="wideSidebarSpan" style="color: var(--sidebarPrimary)">Schedules</span>        </button>
      </div>
      ...
      <div class="tooltip-toggle">
        ...
        <button data-tippy-content="Users" oncontextmenu="showContextMenu(event, `/server/${fetchServerId()}/users`)" onclick="sidebarRefresh();sidebarButtonEvent('serverUsers')" id="sidebarServerUsers" class="sidebarButton">
                    <i class="sidebarIcon icon-users"></i>
                    <span class="wideSidebarSpan" style="color: var(--sidebarPrimary)">Users</span>        </button>
      </div>
      ...
      <div class="tooltip-toggle">
        ...
        <button data-tippy-content="Backups" oncontextmenu="showContextMenu(event, `/server/${fetchServerId()}/backups`)" onclick="sidebarRefresh();sidebarButtonEvent('serverBackups')" id="sidebarServerBackups" class="sidebarButton">
                    <i class="sidebarIcon icon-archive"></i>
                    <span class="wideSidebarSpan" style="color: var(--sidebarPrimary)">Backups</span>        </button>
      </div>
      ...
      <div class="tooltip-toggle">
        ...
        <button data-tippy-content="Network" oncontextmenu="showContextMenu(event, `/server/${fetchServerId()}/network`)" onclick="sidebarRefresh();sidebarButtonEvent('serverNetwork')" id="sidebarServerNetwork" class="sidebarButton">
                    <i class="sidebarIcon icon-network"></i>
                    <span class="wideSidebarSpan" style="color: var(--sidebarPrimary)">Network</span>        </button>
      </div>
      ...
      <div class="tooltip-toggle">
        ...
        <button data-tippy-content="Startup" oncontextmenu="showContextMenu(event, `/server/${fetchServerId()}/startup`)" onclick="sidebarRefresh();sidebarButtonEvent('serverStartup')" id="sidebarServerStartup" class="sidebarButton">
                    <i class="sidebarIcon icon-unplug"></i>
                    <span class="wideSidebarSpan" style="color: var(--sidebarPrimary)">Startup</span>        </button>
      </div>
      ...
      <div class="tooltip-toggle">
        ...
        <button data-tippy-content="Settings" oncontextmenu="showContextMenu(event, `/server/${fetchServerId()}/settings`)" onclick="sidebarRefresh();sidebarButtonEvent('serverSettings')" id="sidebarServerSettings" class="sidebarButton">
                    <i class="sidebarIcon icon-settings"></i>
                    <span class="wideSidebarSpan" style="color: var(--sidebarPrimary)">Settings</span>        </button>
      </div>
      ...
      <div class="tooltip-toggle">
        ...
        <button data-tippy-content="Activity" oncontextmenu="showContextMenu(event, `/server/${fetchServerId()}/activity`)" onclick="sidebarRefresh();sidebarButtonEvent('serverActivity')" id="sidebarServerActivity" class="sidebarButton">
                    <i class="sidebarIcon icon-scroll-text"></i>
      ...
      <div class="tooltip-toggle">
        ...
        <button data-tippy-content="More" style="display:none" id="sidebarServerMore" class="sidebarButton">
                    <i class="sidebarIcon icon-more-vertical"></i>
                    <span class="wideSidebarSpan" style="color: var(--sidebarPrimary)">More</span>        </button>
      </div>
    ...
    <div id="sidebarCategoryAccount" class="sidebarCategory">
      ...
      <div class="tooltip-toggle">
        ...
        <button data-tippy-content="API" oncontextmenu="showContextMenu(event, `/account/api`)" onclick="sidebarRefresh();sidebarButtonEvent('accountApi')" id="sidebarAccountApi" class="sidebarButton">
                    <i class="sidebarIcon icon-globe"></i>
      ...
      <div class="tooltip-toggle">
        ...
        <button data-tippy-content="SSH" oncontextmenu="showContextMenu(event, `/account/ssh`)" onclick="sidebarRefresh();sidebarButtonEvent('accountSsh')" id="sidebarAccountSsh" class="sidebarButton">
                    <i class="sidebarIcon icon-key"></i>
    ...
    <div id="sidebarCategoryGeneral">
      ...
      <div class="tooltip-toggle">
        ...
        <button data-tippy-content="Account" oncontextmenu="showContextMenu(event, `/account`)" onclick="sidebarRefresh();sidebarButtonEvent('accountAccount')" id="sidebarMainAccount" class="sidebarButton">
                    <i class="sidebarIcon icon-user"></i>
                    <span class="wideSidebarSpan" style="color: var(--sidebarPrimary)">Account</span>        </button>
      </div>
      ...
      <div class="tooltip-toggle">
        ...
        <button data-tippy-content="Logout" oncontextmenu="return false;" onclick="sidebarRefresh();sidebarButtonEvent('logout')" id="sidebarMainLogout" class="sidebarButton">
                    <i class="sidebarIcon icon-log-out"></i>
...
<style id="nebula-variables">
  ...
  :root {
    ...
    --sidebarSecondary: #131010;
    --sidebarSecondaryHover: #1c1818;
    --sidebarSecondaryActive: #252020;
    --sidebarSecondarySelected: #66ffd6;
    --sidebarButtonActive: #10a67c;

    --pagePrimary: #e9eaee;
    --pagePrimaryHover: #66ffd6;
    --pageSecondary: #131010;
    --pageSecondaryHover: #1c1818;
    --pageSecondaryActive: #252020;
    --pageSecondarySelected: #2f2828;
    --pageButtonDefault: #66e6ff;
    --pageButtonHover: #3a3232;

    --statusOffline: #524b4b;
    --statusError: #6678ff;
    --statusStarting: #07c101;
    --statusOnline: #11ad81;
...
<script>
  ...
  async function sidebarRefresh() {
    ...
    if(currentPage.startsWith("server")) {
      ...
      if(currentPage === "serverMore") {document.getElementById('sidebarServerMore').className = 'sidebarButton sidebarButtonSelected';} else {document.getElementById('sidebarServerMore').className = 'sidebarButton';}
      setTimeout(() => {
        serverId = fetchServerId()
        sidebarServerButtonRefresh(serverId);
        sidebarMoreRefresh()      }, 300)
  ...
  document.querySelector("head > meta[name='theme-color'][content='#0e4688']").setAttribute("content", "#010101")
</script>
...
<div class="keybinds-content-text-box">
  ...
  <div class="row">
    ...
    <div class="keybinds-column"><p class="keybinds-content-text-dim">
      <code class="keybinds-shortcut">
        <i class="bi bi-option"></i> <i class="bi bi-slash-lg"></i>
      </code><code class="keybinds-shortcut">
        <i class="bi bi-alt"></i> <i class="bi bi-slash-lg"></i>
      </code>
    </p></div>
  </div>
  ...
  <div class="row">
    ...
    <div class="keybinds-column"><p class="keybinds-content-text-dim">
      <code class="keybinds-shortcut">
        <i class="bi bi-option"></i> <i class="bi bi-escape"></i>
      </code>
    </p></div>
  </div>
  ...
  <div class="row">
    ...
    <div class="keybinds-column"><p class="keybinds-content-text-dim">
      <code class="keybinds-shortcut">
        <i class="bi bi-option"></i> K
      </code><code class="keybinds-shortcut">
        <i class="bi bi-alt"></i> F
      </code>
    </p></div>
  </div>
...
<div class="keybinds-content-text-box">
  ...
  <div class="row">
    ...
    <div class="keybinds-column"><p class="keybinds-content-text-dim">
      <code class="keybinds-shortcut">
        <i class="bi bi-option"></i> <i class="bi bi-1-square"></i>
      </code><code class="keybinds-shortcut">
        <i class="bi bi-alt"></i> .
      </code>
    </p></div>
  ...
  <div class="row">
    ...
    <div class="keybinds-column"><p class="keybinds-content-text-dim">
      <code class="keybinds-shortcut">
        <i class="bi bi-option"></i> <i class="bi bi-2-square"></i>
      </code><code class="keybinds-shortcut">
        <i class="bi bi-alt"></i> ,
      </code>
    </p></div>
  ...
  <div class="row">
    ...
    <div class="keybinds-column"><p class="keybinds-content-text-dim">
      <code class="keybinds-shortcut">
        <i class="bi bi-option"></i> <i class="bi bi-3-square"></i>
      </code>
    </p></div>
  ...
  <div class="row">
    ...
    <div class="keybinds-column"><p class="keybinds-content-text-dim">
      <code class="keybinds-shortcut">
        <i class="bi bi-option"></i> <i class="bi bi-4-square"></i>
      </code>
    </p></div>
  ...
  <div class="row">
    ...
    <div class="keybinds-column"><p class="keybinds-content-text-dim">
      <code class="keybinds-shortcut">
        <i class="bi bi-option"></i> <i class="bi bi-5-square"></i>
      </code>
    </p></div>
  ...
  <div class="row">
    ...
    <div class="keybinds-column"><p class="keybinds-content-text-dim">
      <code class="keybinds-shortcut">
        <i class="bi bi-option"></i> <i class="bi bi-6-square"></i>
      </code>
    </p></div>
  ...
  <div class="row">
    ...
    <div class="keybinds-column"><p class="keybinds-content-text-dim">
      <code class="keybinds-shortcut">
        <i class="bi bi-option"></i> <i class="bi bi-7-square"></i>
      </code>
    </p></div>
  ...
  <div class="row">
    ...
    <div class="keybinds-column"><p class="keybinds-content-text-dim">
      <code class="keybinds-shortcut">
        <i class="bi bi-option"></i> <i class="bi bi-8-square"></i>
      </code><code class="keybinds-shortcut">
        <i class="bi bi-alt"></i> M
      </code>
    </p></div>
  </div>
  ...
  <div class="row">
    ...
    <div class="keybinds-column"><p class="keybinds-content-text-dim">
      <code class="keybinds-shortcut">
        <i class="bi bi-option"></i> <i class="bi bi-9-square"></i>
      </code><code class="keybinds-shortcut">
        <i class="bi bi-alt"></i> L
      </code>
    </p></div>
  ...
  <div class="row">
    ...
    <div class="keybinds-column"><p class="keybinds-content-text-dim">
      <code class="keybinds-shortcut">
        <i class="bi bi-option"></i> <i class="bi bi-0-square"></i>
      </code><code class="keybinds-shortcut">
        <i class="bi bi-alt"></i> -
      </code>
    </p></div>
...
<div class="keybinds-content-text-box">
  ...
  <p style="opacity: 0; font-size: 0px;">.</p>
</div>        <p class="keybinds-content-text-dim" style="margin-top: 30px; font-size: 12px;">
  <code class="keybinds-modifier-info" style="min-width:0px;"><i class="bi bi-option"></i></code> Control/Option
</p><p class="keybinds-content-text-dim" style="margin-top: 6.5px; font-size: 12px;">
  <code class="keybinds-modifier-info" style="min-width:0px;"><i class="bi bi-alt"></i></code> Alt
</p><p class="keybinds-content-text-dim" style="margin-top: 6.5px; font-size: 12px;">
  <code class="keybinds-modifier-info" style="min-width:0px;"><i class="bi bi-command"></i></code> Command/Meta
</p><p class="keybinds-content-text-dim" style="margin-top: 6.5px; font-size: 12px;">
  <code class="keybinds-modifier-info" style="min-width:0px;"><i class="bi bi-microsoft"></i></code> Windows
</p><p class="keybinds-content-text-dim" style="margin-top: 6.5px; font-size: 12px;">
  <code class="keybinds-modifier-info" style="min-width:0px;"><i class="bi bi-shift"></i></code> Shift
</p><p class="keybinds-content-text-dim" style="margin-top: 6.5px; font-size: 12px;">
  <code class="keybinds-modifier-info" style="min-width:0px;"><i class="bi bi-escape"></i></code> Escape
</p><p class="keybinds-content-text-dim" style="margin-bottom: 12px; margin-top: 6.5px; font-size: 12px;">
  <code class="keybinds-modifier-info" style="min-width:0px;"><i class="bi bi-slash-lg"></i></code> Slash
</p>
      </div>
    </div>
  ...
  <div id="keybindsHideAlert" class="keybinds-close-alert">
    <p>Use <code style="background-color: var(--pageSecondaryHover); padding: 5px 10px; border-radius: 5px;"><i class="bi bi-option"></i> <i class="bi bi-slash-lg"></i></code> to show these keybinds again.</p>
  </div>                              <script> 
...
function changeFavicon() {
 ...
 link.href = "https://console.xyniqnodes.online/storage/4TNsnNXwzQShgNGH0Zq9HaEHri13uwv2hv9IOUul.png";
 if (oldLink) {
...
changeFavicon();
                                        ...
                                        <script src="/assets/bundle.1f049be2.js" crossorigin="anonymous"></script>
            <script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"version":"2024.11.0","token":"f75e2a52d8c64956aa67ecbd875d3c5d","r":1,"server_timing":{"name":{"cfCacheStatus":true,"cfEdge":true,"cfExtPri":true,"cfL4":true,"cfOrigin":true,"cfSpeedBrain":true},"location_startswith":null}}' crossorigin="anonymous"></script>
</body>
</html>
